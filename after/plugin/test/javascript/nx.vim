" ==============================================================================
" Removed --test-file argument in the test#javascript#nx#build_position function
" ==============================================================================
...
function! test#javascript#nx#build_position(type, position) abort
  ...
  if a:type ==# 'nearest'
    ...
    return [project, name, a:position['file']] " Removed --test-file argument
  elseif a:type ==# 'file'
    return [project,a:position['file']]        " Removed --test-file argument
  else
    return [project]
  endif
endfunction
