...
cmd([[
  augroup BufferTest
    autocmd!
    autocmd FileType javascript nnoremap <leader>tb :call VimuxRunCommand('yarn nx reset && yarn nx test hr-web-app' . ' ' . expand("%"))<CR>|
    autocmd FileType javascript nnoremap <leader>tl :VimuxRunLastCommand<CR>|

    autocmd FileType typescriptreact nnoremap <leader>tb :call VimuxRunCommand('yarn nx reset && yarn nx test hr-web-app' . ' ' . expand("%"))<CR>|
